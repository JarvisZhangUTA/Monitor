  ...
  <div class="signin-container">
    <el-form ref="signinForm" :model="signinForm" :rules="signinRules" class="signin-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="email">
        ...
        <el-input v-model="signinForm.email" name="email" type="text" auto-complete="on" placeholder="email" />
      </el-form-item>
      ...
      <el-form-item>
        <el-button :loading="loading" type="primary" style="width:100%;" @click.native.prevent="handleSignin">
          Sign in
        </el-button>
      </el-form-item>
      <div class="signup-section">
        <router-link :to="`/signup?redirect=${redirect}`" style="float: right">
